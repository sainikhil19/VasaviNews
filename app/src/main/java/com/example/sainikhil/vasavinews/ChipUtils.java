...
class ChipUtils {
    ...
    public static Bitmap getScaledBitmap(Context context, Bitmap bitmap) {
        int width = (int) context.getResources().getDimension(com.example.sainikhil.vasavinews.R.dimen.chip_height);
    ...
    public static Bitmap crateBitmap(Context context, Drawable drawable) {
        int size = (int) context.getResources().getDimension(com.example.sainikhil.vasavinews.R.dimen.chip_height);
